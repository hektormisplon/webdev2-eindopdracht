...
<head>
    ...
    <!-- Fonts -->
    <link href="https://fonts.googleapis.com/css?family=DM+Sans:400,400i&display=swap" rel="stylesheet">
    <!-- Styles -->
...
<body>
    ...
    <div class="container of-hidden">
        <div class="columns">
            ...
            @endauth
            <div class="column col-md-10 col-lg-8 col-xl-8 col-4 col-1-mx-auto">
